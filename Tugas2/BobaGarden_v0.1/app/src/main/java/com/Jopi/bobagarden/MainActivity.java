...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       recentlyViewedList.add(new RecentlyViewed("OPIUM", "", "Rp 80.000", "1", "PCS", card4, b4));
       recentlyViewedList.add(new RecentlyViewed("SAKURA", "", "Rp 85.000", "1", "PCS", card3, b3));
       recentlyViewedList.add(new RecentlyViewed("KELADI GATAL", "", "Rp 130.000", "1", "PCS", card2, b1));
       recentlyViewedList.add(new RecentlyViewed("ENTAHLAH", "", "Rp 5.000", "1", "PCS", card1, b2));
